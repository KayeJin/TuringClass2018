...
void linktree(t_node_p root,t_node_p left,t_node_p right);
...
int main()
{
    ...
    linktree(root,left1,right1);
    linktree(left1,left1left,left1right);
    linktree(right1,right1left,right1right);
...
stack_p initstack()
{
    stack_p ins = (stack_p)malloc(sizeof(t_node));
} 
